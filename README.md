...
Инструмент читает публичный Kwork-канал в Telegram, отбрасывает Bitrix-заказы, отправляет лиды на email и дает готовый текст отклика для ручной отправки.
...
Сейчас фильтр намеренно мягкий: из Kwork-ленты принимаются почти все заказы с ссылкой для отклика, кроме Bitrix/Битрикс. Черновик отклика не просит у заказчика уточнения, доступы или макеты, а сразу предлагает взяться за задачу.
