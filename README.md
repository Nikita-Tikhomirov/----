...
Сканер использует одну Kwork-вкладку: перед каждым проходом обновляет ленту, а при проверке заказа навигирует эту же вкладку на страницу заказа. Новые окна под каждый заказ не открываются.
