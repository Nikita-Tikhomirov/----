...
3. DeepSeek оценивает заказ: сложность, срок, цену, риски и пригодность.
4. Отправляет письмо с AI-оценкой, ссылкой и готовым текстом отклика.
5. Ты открываешь ссылку на заказ.
6. Копируешь блок `СКОПИРОВАТЬ ОТКЛИК` и отправляешь его вручную.
