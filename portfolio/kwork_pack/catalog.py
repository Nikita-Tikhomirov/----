...
_PROJECT_DETAILS = {
    ...
    "pereezd-prosto": ("Переезд просто", "Лидогенерирующие лендинги", "/kvartirnyy-pereezd", "cobalt-green-red"),
    "pravo-opora": ("Право Опора", "Лидогенерирующие лендинги", "/uslugi/spory-s-zastroyshchikom", "forest-gold-burgundy"),
