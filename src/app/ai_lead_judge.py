...
def _build_prompt(text: str) -> str:
    return (
        ...
        "Начни draft_reply с «Здравствуйте!» и сразу назови результат для заказчика. "
        "Не пиши «план такой», «понял задачу», «готов помочь» и другие шаблонные вводные. "
        "Не добавляй каналы связи, мессенджеры, плагины, интеграции или функции, которых нет в заказе. "
        ...
        "Отклик должен звучать как сообщение реального специалиста: 3-5 предложений, 250-650 символов, по делу. "
